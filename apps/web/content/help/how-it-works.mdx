export const toc = [
  ...
  { id: "chunking", label: "Chunking large PRs", level: 2 },
...
A short tour of the pipeline behind **Start Guided Review**.
...
3. **Annotate** — The background worker streams a structured review plan from your provider.
...
The first display step is a synthetic **PR description** unit built from page context, then the model’s units.
