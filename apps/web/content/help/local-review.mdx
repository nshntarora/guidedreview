{/* Unpublished: website currently documents the Chrome extension only. Re-enable in config/docs.ts. */}
...
```
pnpm review -- [dir] --base main --port 8787 --no-open --staged --no-untracked --agent claude-code
```
