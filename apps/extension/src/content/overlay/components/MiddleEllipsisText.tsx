...
/**
 * Single-line text that middle-truncates to fit its container width so both
 * the start and end stay visible (file-path best practice). Full string is
 * always available via `title`.
 */
export function MiddleEllipsisText({ text, className }: MiddleEllipsisTextProps) {
